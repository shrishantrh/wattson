...
//   ../claims/derived/irradiance.json -> public/fixtures/irradiance.json  (NASA POWER overlay)
...
const irradiance = new URL('../claims/derived/irradiance.json', import.meta.url)
...
if (existsSync(irradiance)) { cpSync(irradiance, new URL('irradiance.json', dstFix)); used['irradiance.json'] = 'claims/derived/' }
