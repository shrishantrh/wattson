    ...
    <StageCtx.Provider value={ctx}>
      <div className="app">
        ...
        <header className="topbar">
          ...
          <nav className="toplinks"><a href={href.data()} className={spec.page === 'data' ? 'on' : ''}>Data</a><a href={href.found()} className={spec.page === 'found' ? 'on' : ''}>What we found</a><a href={href.irradiance()} className={spec.page === 'irradiance' ? 'on' : ''}>Day vs night</a><a href={href.method()} className={spec.page === 'method' ? 'on' : ''}>Method</a></nav>
        </header>
