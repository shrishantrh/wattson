...
const PAGES = { landing: Landing, check: Check, compare: Compare, found: Found, region: Region, method: Method, screen: Screener, screener: Screener, explore: Explore, alerts: Alerts, companies: Companies, irradiance: Irradiance, data: Data, alpha: Alpha }
