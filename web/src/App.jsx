...
const PAGES = { landing: Landing, check: Check, compare: Compare, found: Found, region: Region, method: Method, irradiance: Irradiance, screen: Screener, explore: Explore, alerts: Alerts, companies: Companies, data: Data }
