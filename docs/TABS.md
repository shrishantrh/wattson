...
**Say:** *"True on paper. Physically, its ten sites run from 6% to 91% carbon-free depending on the grid each one sits on."* One contract, ten different physical realities. Then immediately: *"We never say they
